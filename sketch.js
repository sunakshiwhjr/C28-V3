...
function preload()
{
  ...
  //do9 goto draw() line 134 (background music)
...
function setup(){
    ...
    //end3 goto cannonball.js line 21
...
function draw(){
    ...
    //end 10 goto keyReleased 245 explosion sound
...
function keyReleased()
{
    if(keyCode === DOWN_ARROW)
    {
     ...
     // cannonBall.shoot();
     //do 11 goto line 219 splash sound
...
//do15 call in line 285
//goto score variable declaration
function gameOver()
{
    swal(
      {
